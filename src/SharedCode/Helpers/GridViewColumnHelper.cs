...
namespace Procbel.Apps.Silverlight.Helpers
{
    public static class GridViewColumnHelper
    {
        ...
        public static readonly DependencyProperty IsImportantProperty =
            DependencyProperty.RegisterAttached("IsImportant", typeof(bool), typeof(GridViewColumn), new PropertyMetadata(false));
        ...
        public static readonly DependencyProperty HideNonImportantColumnsProperty =
            DependencyProperty.RegisterAttached("HideNonImportantColumns", typeof(bool), typeof(RadGridView), new PropertyMetadata(false, OnHideNonImportantColumnsChanged));
