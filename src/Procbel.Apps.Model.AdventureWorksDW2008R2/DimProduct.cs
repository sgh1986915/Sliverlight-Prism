...
namespace Procbel.Apps.Model.AdventureWorksDW2008R2
{
    ...
    public partial class DimProduct
    {
        public DimProduct()
        {
            this.FactAdditionalInternationalProductDescription = new HashSet<FactAdditionalInternationalProductDescription>();
        ...
        public virtual ICollection<FactAdditionalInternationalProductDescription> FactAdditionalInternationalProductDescription { get; set; }
